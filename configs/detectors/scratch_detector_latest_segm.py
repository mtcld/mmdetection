...
data = dict(
    ...
    train=dict(
        ...
        classes=classes,
        test_mode=False,
        ann_file=data_root + 'scratch_latest/annotations/scratch_train.json',
        img_prefix=data_root + 'scratch_latest/images/'),
    val=dict(
        type=dataset_type,
        classes=classes,
        test_mode=False,
        ann_file=data_root + 'scratch_latest/annotations/scratch_valid.json',
...
log_level = 'INFO'
work_dir = './work_dirs/scratch_detector_latest_segm'
load_from = None
resume_from = None
#workflow = [('train', 1)]
